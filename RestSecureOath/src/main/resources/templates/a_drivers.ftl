...
<div class="container col-xs-12 col-md-12 col-lg-12" style="border:solid #ff0000 1px; ">
 -->	<div class="row band col-xs-12 leftmarginadjust" >
 	<div class="row " >
	...
	<div class="row " ng-repeat="x in drivers track by $index" ng-if="x.firstName">
			...
			<div class="mycol col-sm-3">
				...
				Username: {{x.userName}} Password: {{x.password}}<br/>
			</div>
			<div class="mycol col-sm-3">
			NationalID: {{x.NationalID}} NationalID_expiry: {{x.nationalID_expiry}}
			LicenseID: {{x.licenseID}} LicenseID_expiry: {{x.licenseID_expiry}}
			</div>
	</div> 
    ...
    <div  class="scrollable" >
      <div class="col-sm-12">
      	<div  class="col-sm-12">
			...
			<form class="form-horizontal" name="myForm" novalidate>
			  ...
			  <div class="form-group">
			   ...
			   <div class="form-group">
			    ...
			    <div class="form-group">
				    <label class="col-sm-2 control-label">License ID:</label>
				    <div class="col-sm-6">
				    <input type="text" class="form-control" ng-model="driverDTO.licenseID" ng-disabled="!edit" placeholder="License ID"/>
				    </div>
			    </div>
			    <div class="form-group">
				    <label class="col-sm-2 control-label">LicenseID Expiry:{{myForm.confirmPassword.$error.datevalid}}</label>
				    <div class="col-sm-6">
				    <input type="text" name="licenseID_expiry" class="form-control" ng-model="driverDTO.licenseID_expiry" ng-disabled="!edit" placeholder="MM/DD/YYYY" date-validation />
				    </div>
				    <div class="msg-block col-sm-8" ng-show="myForm.$error && myForm.licenseID_expiry.$touched">
					  <span style="color:red" class="msg-error" ng-show="myForm.licenseID_expiry.$error.datevalid" >
					    **Please input date in following format: MM/DD/YYYY.
					  </span>
					</div>
			    </div>
			...
			<hr style="width: 95%;">
			<button ng-click="driversubmit()" class="btn btn-primary" ng-disabled="myForm.$invalid">
			<span></span>Submit
			</button>
        </div>
      </div>
