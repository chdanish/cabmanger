...
<div class="container col-xs-12 col-md-12 col-lg-12" style="border:solid #ff0000 1px; ">
 -->	<div class="row band col-xs-12 col-md-12 col-lg-12" >
	...
	<button ng-click="toggleModal()" class="btn col-xs-3 col-md-3">Add Vehicle</button>
	</div>
	<div class="row band fullwidth" ng-repeat="x in vehicles track by $index" ng-if="x.vehicleId">
